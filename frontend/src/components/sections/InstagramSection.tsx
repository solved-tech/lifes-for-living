...
const InstagramSection: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-soft-gray/40 via-medium-gray/20 to-accent-teal/15">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center space-y-6 mb-16">
          <div className="inline-flex items-center space-x-3 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
            <div className="w-8 h-8 bg-gradient-to-tr from-primary via-accent-teal to-accent-orange rounded-lg flex items-center justify-center">
